...
export const PANEL_IDS = [...PLOT_IDS, ...POLAR_PLOT_IDS, "boxPreview"];
...
export const LIBRARY_BRAND_ALIASES = [
  ...
  ["SEAS", /\bSEAS\b/i],
  ["PURIFI", /\bPURIFI\b/i],
  ["Monacor", /\bMonacor\b/i],
  ["Accuton", /\bAccuton\b/i],
  ["Eighteen Sound", /\b(?:Eighteen|18)\s*Sound\b/i],
  ["RCF", /\bRCF\b/i],
  ["Markaudio", /\bMark\s*Audio\b/i],
  ["Sica", /\bSica\b/i],
  ["Fane", /\bFane\b/i],
  ["Precision Devices", /\bPrecision\s+Devices\b/i],
  ["Audio Technology", /\bAudio\s+Technology\b/i],
  ["ETON", /\bETON\b/i],
  ["Fostex", /\bFostex\b/i],
  ["JBL Selenium", /\bJBL\s+Selenium\b/i],
  ["JBL", /\bJBL\b/i],
  ["GRS", /\bGRS\b/i],
